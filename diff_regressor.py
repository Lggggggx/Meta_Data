...
for testdataset in testdatasetnames:
    ...
    # SGDRegressor
    # sgdr = SGDRegressor(alpha=5e-05, eta0=0.005, learning_rate='invscaling')
    ...
    # joblib.dump(sgdr, "sgdr_results/" + testdataset + "meta_sgdr.joblib")
    ...
    alibox = ToolBox(X=X, y=y, query_type='AllLabels', saving_path='./experiment_result/different_regressor/')
    ...
    analyser.plot_learning_curves(title=testdataset, std_area=False, saving_path='./experiment_result/different_regressor/')
