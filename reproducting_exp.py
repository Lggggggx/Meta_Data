...
from alipy.data_manipulate.al_split import split_load
...
#   'wdbc']
#  , 'clean1', 'ethn', 'blood', 'breast-cancer-wisc', 'wdbc'
...
savefloder_path = './experiment_result/combination_classify/random_uncertainty/'
# metadata regressior
...
for testdataset in testdatasetnames:
    ...
    plt = analyser.plot_learning_curves(title=testdataset, std_area=False, saving_path=savefloder_path + testdataset +'/')
    # plt.close()
