...
ethn_metadata = np.load('./newmetadata/wdbc_rforest_metadata.npy')
...
np.save('./newmetadata/process_wdbc_rforest_metadata.npy', process_ethn_metadata)     
...
np.save('./newmetadata/process_classify_wdbc_rforest_metadata.npy', process_ethn_metadata)