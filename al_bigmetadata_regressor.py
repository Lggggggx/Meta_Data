...
savefloder_path = './experiment_result/ridge_regressor/qt50_7_210000/australian_lrmetadata_0.01/'
# metadata regressior
...
# meta_regressor = {
#     'origin_sgd': joblib.load('./bigmetadata/regressor_model/australian_origin_regressor.joblib'),
#     's_c_50_1model': joblib.load('./bigmetadata/regressor_model/australian_s-c-50-inter2-regressor.joblib'),
#     's_c_100_1model': joblib.load('./bigmetadata/regressor_model/australian_s-c-100-inter2-regressor.joblib'),
#     's_c_200_1model': joblib.load('./bigmetadata/regressor_model/australian_s-c-200-inter2-regressor.joblib'),
#     's_c_300_1model': joblib.load('./bigmetadata/regressor_model/australian_s-c-300-inter2-regressor.joblib')
# }

# meta_regressor = {
#     'origin_sgd': joblib.load('./bigmetadata/regressor_model/australian_origin_regressor.joblib'),
#     'q_t_50_1model': joblib.load('./bigmetadata/regressor_model/australian_q-t-50-inter2-regressor.joblib'),
#     'q_t_100_1model': joblib.load('./bigmetadata/regressor_model/australian_q-t-100-inter2-regressor.joblib'),
#     'q_t_200_1model': joblib.load('./bigmetadata/regressor_model/australian_q-t-200-inter2-regressor.joblib'),
#     'q_t_300_1model': joblib.load('./bigmetadata/regressor_model/australian_q-t-300-inter2-regressor.joblib')
# }

meta_regressor = {
    'ridge_qt50_7': joblib.load('./australian_qt50_7_ridge.joblib'),
}
